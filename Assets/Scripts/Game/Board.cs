...
public class Board : MonoBehaviour
{
    ...
    {
        if (!startTile || !endTile || !IsPosibleMove() || swappingPieces) yield break;
        swappingPieces = true;
    ...
    {
        GameManager.Instance.AddPoints(piecesToClear.Count, pointsPerMatch);
